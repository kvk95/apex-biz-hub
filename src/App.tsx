...
const App = () => {
  // Temporary simple login state; replace with real logic
            ...
            {isLoggedIn ? (
              <Route path="/" element={<MainLayout />}>
                ...
                <Route
                  path="todo"
                  element={
                    <GenericPage title="To-Do" description="Task management" />
                  }
                />
                <Route
                  path="notes"
                ...
                <Route
                  path="brands"
                  element={
                    <GenericPage title="Brands" description="Manage brands" />
                  }
                />
                <Route
                  path="units"
                ...
                <Route
                  ...
                  element={
                    <GenericPage
                      title="Manage Stock"
                      description="Stock levels management"
                    />
                  }
                />
                <Route
                ...
                <Route
                  ...
                  element={
                    <GenericPage
                      title="Discount Plan"
                      description="Discount strategies"
                    />
                  }
                />
                ...
                <Route
                  path="income"
                  element={
                    <GenericPage title="Income" description="Track income" />
                  }
                />
                <Route
                  path="bank-accounts"
                ...
                <Route
                  path="stores"
                  element={
                    <GenericPage title="Stores" description="Store locations" />
                  }
                />
                <Route
                  path="warehouses"
                ...
                <Route
                  path="cms/*"
                  element={
                    <GenericPage title="CMS" description="Content management" />
                  }
                />
                <Route
                  path="settings/*"
