          ...
          <Routes>
            ...
            {isLoggedIn ? (
              <Route path="/" element={<MainLayout />}>
                ...
                <Route path="inventory/expired-products" element={<ExpiredProducts />} />
                <Route path="inventory/low-stocks" element={<LowStocks />} />
                <Route path="inventory/categories" element={<Category />} />
                <Route path="inventory/sub-categories" element={<SubCategory />} />
                ...
                <Route path="finance/expenses/categories" element={<ExpenseCategory />} />
                <Route path="finance/income/list" element={<Income />} />
                <Route path="finance/income/categories" element={<IncomeCategory />} />
                ...
                <Route path="finance/account-statement" element={<AccountStatement />} />
                ...
                {/* Settings */}  
                <Route path="settings/general/profile" element={<GeneralSettings />} />
                <Route path="settings/general/security" element={<SecuritySettings />} />
                <Route path="settings/general/notifications" element={<Notification/>} />
                <Route path="settings/general/connected-apps" element={<ConnectedApps />} /> 
                <Route path="settings/website/system" element={<SystemSettings />} />
                <Route path="settings/website/company" element={< CompanySettings />} />
                <Route path="settings/website/localization" element={<LocalizationSettings />} />
                <Route path="settings/website/prefixes" element={<Prefixes />} />
                <Route path="settings/website/preference" element={<Preference />} />
                <Route path="settings/website/appearance" element={<Appearance/>} />
                <Route path="settings/website/social-auth" element={<SocialAuthentication/>} />
                <Route path="settings/website/language" element={<LanguageSettings/>} />
                <Route path="settings/app/invoice-settings" element={<InvoiceSettings/>} />
                <Route path="settings/app/invoice-templates" element={<InvoiceTemplates />} />
                <Route path="settings/app/printer" element={<PrinterSettings />} />
                <Route path="settings/app/pos" element={<PosSettings />} />
                <Route path="settings/app/signatures" element={<Signatures />} />
                <Route path="settings/app/custom-fields" element={<CustomFields  />} /> 
                <Route path="settings/system/email/settings" element={<EmailSettings/>} />
                <Route path="settings/system/email/templates" element={<EmailTemplates />} />
                <Route path="settings/system/sms/settings" element={<SmsSettings />} />
                <Route path="settings/system/sms/templates" element={<SmsTemplates />} />
                <Route path="settings/system/otp" element={<OtpSettings />} />
                <Route path="settings/system/gdpr-cookies" element={<GdprSettings />} /> 
                <Route path="settings/financial/payment-gateway" element={<PaymentGatewaySettings />} />
                <Route path="settings/financial/bank-accounts" element={<BankSettingsGrid />} />
                <Route path="settings/financial/tax-rates" element={<TaxRates/>} />
                <Route path="settings/financial/currencies" element={<CurrencySettings/>} /> 
                <Route path="settings/other/storage" element={<StorageSettings />} />
                <Route path="settings/other/ban-ip" element={<BanIpAddress />} />
