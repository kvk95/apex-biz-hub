...
const bankSettingsData = [
  ...
  },
  {
    ...
    branchName: "Seattle Branch",
    accountNumber: "2233445566",
    accountHolder: "Frank Blue",
    ifscCode: "CAP1US33",
    status: "Active",
  },
  {
    id: 9,
    bankName: "US Bank",
    branchName: "Denver Branch",
    accountNumber: "7788990011",
    accountHolder: "Grace Yellow",
    ifscCode: "USBKUS44",
    status: "Active",
  },
  {
...
export default function BankSettingsGrid() {
  ...
  // Data state
  const [data, setData] = useState(bankSettingsData);
