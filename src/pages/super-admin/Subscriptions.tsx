...
export default function Subscriptions() {
  ...
  const filteredSubscriptions = useMemo(() => {
    return subscriptions.filter((sub) => {
      const matchesPlan = filterPlan ? sub.subscriptionPlan === filterPlan : true;
  ...
  return (
    <div className="min-h-screen bg-gray-100 text-gray-800 font-sans">
      <title>Subscriptions - Dreams POS</title>

      <div className="max-w-7xl mx-auto p-6">
        {/* Page Title */}
        <h1 className="text-3xl font-semibold mb-6">Subscriptions</h1>
        ...
        <section className="bg-white rounded shadow p-6 mb-6 overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200 text-sm">
            <thead className="bg-gray-50">
              <tr>
                <th className="px-4 py-3 text-left font-semibold text-gray-700">Subscription ID</th>
