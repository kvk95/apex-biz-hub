    ...
    <>
      ...
      <div className="min-h-screen bg-gray-100 font-sans text-gray-900">
        <div className="max-w-7xl mx-auto p-6">
          {/* Title */}
          <h1 className="text-3xl font-semibold mb-6">Purchase Transaction</h1>
          ...
          <section className="bg-white rounded shadow p-6 mb-8">
            ...
            <form className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div>
                <label htmlFor="paidAmount" className="block text-sm font-medium mb-1">
                  Paid Amount
                </label>
                <input
                  type="number"
          ...
          <section className="bg-white rounded shadow p-6">
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full border border-gray-300 divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    <th className="px-4 py-2 text-left text-sm font-medium text-gray-700 border-r border-gray-300">Invoice No</th>
                    <th className="px-4 py-2 text-left text-sm font-medium text-gray-700 border-r border-gray-300">Supplier Name</th>
                    <th className="px-4 py-2 text-left text-sm font-medium text-gray-700 border-r border-gray-300">Purchase Date</th>
                    <th className="px-4 py-2 text-right text-sm font-medium text-gray-700 border-r border-gray-300">Total Amount</th>
                    <th className="px-4 py-2 text-right text-sm font-medium text-gray-700 border-r border-gray-300">Paid Amount</th>
                    <th className="px-4 py-2 text-right text-sm font-medium text-gray-700 border-r border-gray-300">Due Amount</th>
                    <th className="px-4 py-2 text-center text-sm font-medium text-gray-700 border-r border-gray-300">Status</th>
                ...
                <tbody className="divide-y divide-gray-200 bg-white">
                  {paginatedData.map((item) => (
                    <tr key={item.id} className="hover:bg-gray-50">
                      <td className="px-4 py-2 whitespace-nowrap border-r border-gray-300">{item.invoiceNo}</td>
                      <td className="px-4 py-2 whitespace-nowrap border-r border-gray-300">{item.supplierName}</td>
                      <td className="px-4 py-2 whitespace-nowrap border-r border-gray-300">{item.purchaseDate}</td>
                      ...
                      <td className="px-4 py-2 whitespace-nowrap text-center">
                        <button
                          ...
                          onClick={() => alert(`Edit functionality for ${item.invoiceNo} not implemented.`)}
                        >
            ...
            >
              ...
              <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-center">
                ...
                <div>
                  <nav className="relative z-0 inline-flex rounded-md shadow-sm -space-x-px ml-6" aria-label="Pagination">
                    <button
